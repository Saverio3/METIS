    ...
    <>
      <style jsx="true">{`
        ...
        .dark-theme {
            ...
            --feature-card-shadow: 0 4px 6px rgba(0, 0, 0, 0.3);
            --footer-bg: #0f172a;
            --footer-text: #f3f4f6;
            --footer-secondary: #9ca3af;
            --border-hover: rgba(165, 180, 252, 0.1);
        }
        ...
        .dark-theme .pricing-table tbody tr:nth-child(even) {
        ...
        .dark-theme footer .text-gray-400 {
            color: var(--footer-secondary);
        }
      `}</style>

      {/* Navbar */}
      <nav className="navbar fixed w-full z-50 shadow-sm">
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center">
              ...
              <div className="flex space-x-4 ml-6 items-center">
                ...
                >
                  <i className="toggle-icon sun fas fa-sun"></i>
                  <i className="toggle-icon moon fas fa-moon"></i>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 md:pt-32 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="col-span-1">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 slide-in" style={{ animationDelay: "0.5s" }}>
            ...
            <div className="col-span-1 hidden md:block">
              <div className="relative">
                ...
                <div className="relative bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl floating">
                  {/* SVG Graph Animation */}
                  <svg width="100%" height="300" viewBox="0 0 500 300">
                    ...
                    {/* Y-axis labels */}
                    <text x="30" y="250" fontSize="12" textAnchor="end" fill="currentColor">0</text>
                    <text x="30" y="180" fontSize="12" textAnchor="end" fill="currentColor">50</text>
                    <text x="30" y="110" fontSize="12" textAnchor="end" fill="currentColor">100</text>
                    <text x="30" y="40" fontSize="12" textAnchor="end" fill="currentColor">150</text>

                    {/* X-axis labels */}
                    <text x="50" y="270" fontSize="12" textAnchor="middle" fill="currentColor">Jan</text>
                    <text x="125" y="270" fontSize="12" textAnchor="middle" fill="currentColor">Feb</text>
                    <text x="200" y="270" fontSize="12" textAnchor="middle" fill="currentColor">Mar</text>
                    <text x="275" y="270" fontSize="12" textAnchor="middle" fill="currentColor">Apr</text>
                    <text x="350" y="270" fontSize="12" textAnchor="middle" fill="currentColor">May</text>
                    <text x="425" y="270" fontSize="12" textAnchor="middle" fill="currentColor">Jun</text>
                    ...
                    <text x="350" y="23" fontSize="12" fill="currentColor">Actual</text>

                    <rect x="330" y="40" width="12" height="3" fill="#10B981" />
                    <text x="350" y="43" fontSize="12" fill="currentColor">Predicted</text>
                  </svg>

                  <div className="flex justify-between items-center mb-3 mt-4">
                    <h3 className="text-lg font-semibold">Marketing Mix Model</h3>
                    <div className="text-xs px-2 py-1 rounded-full bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200">R² = 0.92</div>
                  </div>
      ...
      <section id="features" className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">Our platform offers everything you need to build, test, and optimize marketing mix models.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="feature-card rounded-xl p-6">
              <div className="h-12 w-12 flex items-center justify-center rounded-md bg-indigo-100 dark:bg-indigo-900 text-indigo-600 dark:text-indigo-300 mb-4">
                <i className="fas fa-upload text-xl"></i>
              </div>
              <h3 className="text-xl font-semibold mb-2">Secure Data Upload</h3>
              <p className="text-gray-600 dark:text-gray-300">Import data from Excel with complete privacy. Nothing is stored online – your data stays on your device.</p>
            </div>
            ...
            <div className="feature-card rounded-xl p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">Transform, split, lag, or create weighted variables. Build S-curves and diminishing returns models without coding.</p>
            </div>
            ...
            <div className="feature-card rounded-xl p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">Test variables before adding them to your model. Preview coefficient changes and statistic improvements.</p>
            </div>
            ...
            <div className="feature-card rounded-xl p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">Run comprehensive diagnostic tests to validate your model, from multicollinearity to heteroscedasticity tests.</p>
            </div>
            ...
            <div className="feature-card rounded-xl p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">Break down model results to see the contribution of each variable or group to your KPI over time.</p>
            </div>
            ...
            <div className="feature-card rounded-xl p-6">
              ...
              <p className="text-gray-600 dark:text-gray-300">Export your complete model, including transformations, coefficients, and diagnostics to Excel for sharing.</p>
            </div>
          </div>
      ...
      {/* Advantages Section */}
      <section id="advantages" className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold">Why Choose METIS MMM</h2>
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">Our platform offers unique advantages over traditional MMM approaches.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="bg-white dark:bg-gray-700 rounded-xl shadow-xl overflow-hidden">
                <div className="px-6 py-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-6">Our intuitive interface allows marketers and analysts to build sophisticated models without writing code.</p>
              ...
              <div className="mt-8 bg-white dark:bg-gray-700 rounded-xl shadow-xl overflow-hidden">
                <div className="px-6 py-8">
                  <h3 className="text-2xl font-bold mb-4 text-gradient">Complete Privacy</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-6">Your sensitive marketing data never leaves your device. Perfect for organizations with strict data policies.</p>
            ...
            <div className="relative">
              ...
              <div className="bg-white dark:bg-gray-700 rounded-xl shadow-xl overflow-hidden p-2">
                  ...
                  <div className="rounded-lg bg-white dark:bg-gray-700 p-4 shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="flex space-x-2">
                        <div className="h-6 w-6 bg-gray-100 dark:bg-gray-600 rounded flex items-center justify-center text-xs">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="px-2 py-1 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 text-xs rounded-full">Active</div>
                      </div>
                      <div className="h-32 w-full bg-gray-50 dark:bg-gray-800 rounded relative overflow-hidden">
                        {/* S-Curve */}
                        ...
                        {/* Labels */}
                        <div className="absolute bottom-1 left-2 text-xs text-gray-500 dark:text-gray-400">Spend</div>
                        <div className="absolute top-1 left-2 text-xs text-gray-500 dark:text-gray-400">Response</div>
      ...
      {/* Comparison Section */}
      <section id="comparison" className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold">How We Compare</h2>
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">See how METIS MMM stacks up against traditional methods and other platforms.</p>
          </div>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">Join hundreds of companies that use METIS MMM for their MMM needs.</p>
          </div>
              ...
              <div className="testimonial-slide px-4">
                <div className="bg-white dark:bg-gray-700 rounded-xl shadow-sm p-8">
                  <div className="flex items-center mb-4">
                    <div className="h-12 w-12 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center text-indigo-600 dark:text-indigo-300 mr-4">
                      <span className="text-xl font-bold">JD</span>
                    </div>
                    <div>
                      <div className="font-medium">Jane Doe</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">Marketing Director, Tech Co</div>
                    </div>
                  </div>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">"METIS MMM has transformed how we approach marketing measurement. We went from spending weeks on model development to having insights in days. The interface is intuitive enough for our marketing team while providing the statistical rigor our data scientists expect."</p>
                ...
                <div className="bg-white dark:bg-gray-700 rounded-xl shadow-sm p-8">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500 dark:text-gray-400">Analytics Lead, Retail Inc</div>
                    </div>
                  </div>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">"The privacy features sold us immediately. Our legal team was concerned about sharing marketing data with external vendors, but with METIS MMM, all processing happens locally. The capabilities rival what we were getting from consultants at a fraction of the cost."</p>
                  <div className="flex text-yellow-400">
                    <i className="fas fa-star"></i>
                    <i className="fas fa-star"></i>
                    <i className="fas fa-star"></i>
      ...
      <section id="pricing" className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Monthly Plan */}
            <div className="bg-white dark:bg-gray-700 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-600 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className="p-8">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-2xl font-bold">Monthly</h3>
                  <span className="px-3 py-1 text-xs font-semibold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/50 rounded-full">
                    Flexible
                  </span>
                </div>
                <div className="mb-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mt-2">Billed monthly</p>
                </div>
            ...
            {/* Quarterly Plan */}
            <div className="bg-white dark:bg-gray-700 rounded-2xl overflow-hidden border-2 border-indigo-500 shadow-xl transform scale-105 relative z-10 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
              ...
              <div className="p-8 pt-12">
                ...
                <div className="mb-6">
                  ...
                  <span className="text-xl text-gray-500 dark:text-gray-400">/mo</span>
                  <p className="text-gray-500 dark:text-gray-400 mt-2">$3,750 billed every 3 months</p>
                </div>
                <ul className="mb-8 space-y-4">
                <li className="flex items-center">
                    <svg className="w-5 h-5 text-green-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-600 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className="p-8">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-2xl font-bold">Semi-Annual</h3>
                  <span className="px-3 py-1 text-xs font-semibold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/50 rounded-full">
                    Save 33%
                  </span>
                </div>
                <div className="mb-6">
                  ...
                  <span className="text-xl text-gray-500 dark:text-gray-400">/mo</span>
                  <p className="text-gray-500 dark:text-gray-400 mt-2">$6,000 billed every 6 months</p>
                </div>
                <ul className="mb-8 space-y-4">
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-green-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-16 text-center bg-gray-50 dark:bg-gray-800 p-8 rounded-xl max-w-4xl mx-auto">
            ...
            <a
              ...
              className="inline-flex items-center px-6 py-3 border border-indigo-600 text-indigo-600 dark:text-indigo-400 dark:border-indigo-400 font-medium rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors"
            >
          ...
          <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden">
            <div className="p-6">
              <div className="mb-4">
                ...
                <input className="appearance-none border border-gray-300 dark:border-gray-600 rounded w-full py-3 px-4 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500" id="email" type="email" placeholder="you@example.com" />
              </div>
              <div className="mb-6">
                <label className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2" htmlFor="company">
                  Company
                </label>
                <input className="appearance-none border border-gray-300 dark:border-gray-600 rounded w-full py-3 px-4 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500" id="company" type="text" placeholder="Your Company" />
              </div>
              <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-4 text-center">By signing up, you agree to our Terms of Service and Privacy Policy.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-800 dark:bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">METIS MMM</h3>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-gray-400">
              © 2025 METIS MMM. All rights reserved.
            </div>
