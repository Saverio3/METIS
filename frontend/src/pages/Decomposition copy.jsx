// In src/pages/Decomposition.jsx
    ...
    return (
      <div className="chart-container">
        <ChartComponent
          ...
          chartArea={{ border: { width: 0 } }}
        >
          <Inject services={[StackingColumnSeries, DateTime, Legend, Tooltip, DataLabel]} />
          <SeriesCollectionDirective>
    ...
    return (
      <div className="chart-container">
        <ChartComponent
          ...
          chartArea={{ border: { width: 0 } }}
        >
          <Inject services={[StackingColumnSeries, LineSeries, DateTime, Legend, Tooltip, DataLabel]} />
          <SeriesCollectionDirective>
