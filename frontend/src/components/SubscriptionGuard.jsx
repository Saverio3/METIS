  ...
  const checkSubscriptionStatus = async () => {
    try {
      ...
      if (response.success &&
        ...
        // Only show subscription modal if not subscribed
        setShowSubscriptionModal(!hasValidSubscription);

        console.log(`Has valid subscription: ${hasValidSubscription}`);
      } else {
        // Handle response error
        console.error('Invalid subscription response:', response.error || 'Unknown error');
